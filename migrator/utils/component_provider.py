...
class ComponentProvider:
    ...
    def extract_components(self) -> list[ComponentFile]:
        view_files = FileUtils.find_files_in_directory("View.java", os.environ["SWING_PROJECT_PATH"])
        model_files = FileUtils.find_files_in_directory("Model.java", os.environ["SWING_PROJECT_PATH"])
        presenter_files = FileUtils.find_files_in_directory("Presenter.java", os.environ["SWING_PROJECT_PATH"])
